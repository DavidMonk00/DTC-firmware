...
# Extended payload area (uses readout / ethernet area)

create_pblock payload
resize_pblock [get_pblocks payload] -add {SLICE_X30Y0:SLICE_X191Y499}
resize_pblock [get_pblocks payload] -add {RAMB18_X2Y0:RAMB18_X12Y199}
resize_pblock [get_pblocks payload] -add {RAMB36_X2Y0:RAMB36_X12Y99}
