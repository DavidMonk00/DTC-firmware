...
HD_PWD='/home/dmonk/Firmware/DTC-firmware/top/top.runs/blockram_512x36_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockram_512x36.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockram_512x36.tcl
