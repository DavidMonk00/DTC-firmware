...
--         clk : in std_logic;
--         header : in tHeader;
--         StubPipeIn(0)(i) : in tCICStub;
--         bus_in : in tFMBusArray;
--         link_index : in unsigned(4 downto 0);
--
--         -- Output Ports --
--         StubArray(i) : out tStub := NullStub;
...
-- address(7 downto 0) <= std_logic_vector(link_index) & std_logic_vector(StubPipeIn(0)(i).row(10 downto 8)); -- Highest 3 bits are assumed to be the FE ID - No idea if this is correct as I didn't make the specifications
--
--
...
--         tmp_buff.valid <= StubPipeIn(0)(i).valid;
--         tmp_buff.bx <= (header.boxcar_number(4 downto 0) + StubPipeIn(0)(i).bx(2 downto 0)) mod 18;
--         tmp_buff.bend <= StubPipeIn(0)(i).bend;
--         tmp_buff.strip <= StubPipeIn(0)(i).row(7 downto 0);
--         tmp_buff.column <= StubPipeIn(0)(i).column;
--     end if;
-- end process;
--
--
